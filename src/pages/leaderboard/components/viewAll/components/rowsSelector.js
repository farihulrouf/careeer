...
import "../../../../../assets/css/RowsSelector.css";
...
export default class DropDownSelector extends Component {
  ...
  showOptionsHandler = (e) => {
    ...
    if (this.props.selected === "") {
      ...
      let ind = this.props.NoOfRows.findIndex(
        (ele) => this.props.selected === ele
      );
      this.setState({
        showOptions: !this.state.showOptions,
        activeOption: ind,
    ...
    return (
      ...
      >
        <div
          ...
          id="selectorField"
        >
          <div style={className.selectedDisplay}> {this.props.selected}</div>
        ...
        <div style={className.optionsList} id="optionsList">
          <ul style={className.unOrderList} className="unOrderList">
            {this.props.NoOfRows.map((element, index) => {
              return (
                <li
                  onMouseDown={(e) => this.props.onClick(e, index)}
