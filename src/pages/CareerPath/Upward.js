...
class Upward extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
      ...
      requiredSkills: [
        {
          title: "Technical",
          description: "Microsoft 365 Implementation",
        },
        {
          title: "Functional",
          description:
          ...
          <div className="Upward-main">
            ...
            <div className="Lateral-step">
              {this.state.careerPathDetail.designationMatrix
                .filter(
                  (eachDesignation) => eachDesignation.careerpath === "UPWARD"
                )
                .map((eachDesignation, id) => (
                  <div
                    ...
                    className={
                      this.state.careerPathDetail.upwardDesignationCount > 1
