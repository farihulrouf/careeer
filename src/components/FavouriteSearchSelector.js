...
font-family:inherit;
outline:none;
.FavouriteSearchSelectorContainer{
  width: 100%;
  height: 100%;
  position: relative;
  outline: none;
...
class FavouriteSearchSelector extends Component {
  ...
  render() {
    return (
      ...
      >
        <div className="FavouriteSearchSelectorContainer">
...
export default FavouriteSearchSelector;
