    ...
    <div style={{ height: "100%" }}>
      <div style={styles.MainContainer}>
        ...
        <div className="scroll-container" style={styles.SummaryContainer}>
          {(props.projectDetails.length &&
            props.projectDetails.map((ele, index) => {
              return (
                <div
                  style={{
                    flex: 1,
                ...
                >
                      ...
                      style={{
                        ...
                        visibility:
                          props.type === "timeTracker"
                            ? props.projectDetails.length - 1 !== index
                              ? "show"
                              : "hidden"
                            : "hidden",
                      }}
                  ...
                  >
                    ...
                    >
                      {ele.descriptions || ele.Description}
                    </div>
                  </div>
                </div>
              );
